...
public class Project extends JFrame implements ActionListener {
    ...
    Project() {
        ...
        JMenuItem TakeStudentAttendance = new JMenuItem("Student Attendance");
        TakeStudentAttendance.setBackground(Color.WHITE);
        TakeStudentAttendance.addActionListener(this);
        Attendance.add(TakeStudentAttendance);
